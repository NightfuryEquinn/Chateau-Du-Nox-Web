    ...
    <div class="contact-container">
      ...
      <div class="contact-visit-wrapper">
        <div class="contact-section">
          ...
          <a href="mailto:service@chateaudunox.com" class="contact-content">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" color="#242C34" viewBox="0 0 24 24">
          ...
          <a href="tel:1-800-279-0114" class="contact-content">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" color="#242C34" viewBox="0 0 24 24">
          ...
          <a href="https://www.instagram.com/accounts/login/" class="contact-content">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" color="#242C34" viewBox="0 0 24 24">
              <path fill="currentColor" d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4a5.8 5.8 0 0 1-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8A5.8 5.8 0 0 1 7.8 2m-.2 2A3.6 3.6 0 0 0 4 7.6v8.8C4 18.39 5.61 20 7.6 20h8.8a3.6 3.6 0 0 0 3.6-3.6V7.6C20 5.61 18.39 4 16.4 4zm9.65 1.5a1.25 1.25 0 0 1 1.25 1.25A1.25 1.25 0 0 1 17.25 8A1.25 1.25 0 0 1 16 6.75a1.25 1.25 0 0 1 1.25-1.25M12 7a5 5 0 0 1 5 5a5 5 0 0 1-5 5a5 5 0 0 1-5-5a5 5 0 0 1 5-5m0 2a3 3 0 0 0-3 3a3 3 0 0 0 3 3a3 3 0 0 0 3-3a3 3 0 0 0-3-3"/>
            </svg>
            <p>chateau_du_nox</p>
          </a>
          <a href="https://www.facebook.com/" class="contact-content">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" color="#242C34" viewBox="0 0 24 24">
          ...
          <a href="https://twitter.com/login" class="contact-content">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" color="#242C34" viewBox="0 0 24 24">
      ...
      <div class="newsletter-section">
        ...
        <div class="newsletter-wrapper">
          ...
          <div class="newsletter-inner-wrapper">
            <asp:TextBox CssClass="input-box" ID="SubscribeInput" runat="server" TextMode="Email"></asp:TextBox>

            <asp:Button CssClass="input-submit" ID="SubscribeButton" runat="server" Text="I am in!" OnClick="SubscribeButton_Click" />
          </div>
        </div>
      </div>
    </div>
