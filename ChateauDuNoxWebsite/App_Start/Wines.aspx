<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wines.aspx.cs" Inherits="ChateauDuNoxWebsite.App_Start.Wines" %>
...
<head runat="server">
  ...
  <!--Link to CSS-->
  <link rel="stylesheet" href="../App_Styles/Wines.css" />
  ...
  <!--Title-->
  <title>Chateau Du Nox - Wines</title>
</head>
<body>
