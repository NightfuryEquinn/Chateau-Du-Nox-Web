<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboutUs.aspx.cs" Inherits="ChateauDuNoxWebsite.App_Start.AboutUs" %>
...
<head runat="server">
  ...
  <!--Link to CSS-->
  <link rel="stylesheet" href="../App_Styles/AboutUs.css" />
  ...
  <!--Title-->
  <title>Chateau Du Nox - About Us</title>
</head>
<body>
  <form id="form1" runat="server">
    ...
    <div class="about-container">
      <div class="hero-container">
        <img src="../App_Assets/about-us.jpeg" />
        <div class="hero-wrapper">
          <h1>Essence of luxury and tradition</h1>

          <p>At Chateau Du Nox, we are a team of passionate individuals united by our love for winemaking and our deep respect for nature. Our skilled viticulturists, oenologists, and cellar masters work tirelessly to ensure that each grape is harvested at its peak, and every wine reflects the unique terroir of our estate. We take pride in our heritage, drawing inspiration from centuries-old winemaking traditions while embracing innovation to create wines that are both timeless and contemporary.</p>
        </div>
      </div>
      <div class="stats-container counters">
        <div class="stats counter">
          <h2>Years Pursued in Research & Craft</h2>
          <h3><span data-count="36">0</span></h3>
        </div>
        <div class="stats counter">
          <h2>Global Partners Worldwide</h2>
          <h3><span data-count="109">0</span></h3>
        </div>
        <div class="stats counter">
          <h2>Awards Achieved in Winemaking</h2>
          <h3><span data-count="71">0</span></h3>
        </div>
        <div class="stats counter">
          <h2>Hectares of Vineyards Nurtured</h2>
          <h3><span data-count="85">0</span></h3>
        </div>
      </div>
      <div class="section-outer-wrapper">
        <div class="section-container">
          <div class="section-wrapper">
            <img src="../App_Assets/journey.jpg" />
          </div>
          <div class="section-content">
            <h3>Who Are We and Our Journey</h3>
            <p>Chateau Du Nox, a distinguished winery nestled in the heart of breathtaking vineyards, where every bottle tells a story of passion, craftsmanship, and unparalleled quality. Since our establishment in 1995, we have been committed to creating wines that embody the essence of luxury and tradition, earning us recognition and accolades from wine enthusiasts and experts worldwide. Our journey began with a vision to produce wines that are not just exceptional but also reflective of our terroir's unique character. Over the years, we have honed our skills and embraced a philosophy that blends time-honored winemaking traditions with innovative techniques, resulting in wines that captivate the senses and leave a lasting impression.</p>
          </div>
        </div>
        <div class="section-container">
          <div class="section-wrapper">
            <img src="../App_Assets/craft.jpg" />
          </div>
          <div class="section-content">
            <h3>Craftsmanship and Excellence</h3>
            <p>Our pursuit goes beyond crafting exceptional wines; it is about creating moments of joy, celebration, and connection. We believe that wine is more than a beverage; it is a story waiting to be shared. Through our wines, we aim to transport you to the vineyards, allowing you to experience the beauty and richness of our land in every sip. Whether you're indulging in our acclaimed reds, elegant whites, or sparkling delights, each bottle encapsulates the passion, dedication, and artistry that define Chateau Du Nox.</p>
          </div>
        </div>
      </div>
    </div>
