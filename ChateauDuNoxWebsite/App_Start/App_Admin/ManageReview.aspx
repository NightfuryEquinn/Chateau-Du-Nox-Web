<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ManageReview.aspx.cs" Inherits="ChateauDuNoxWebsite.App_Start.App_Admin.ManageReview" %>
...
<head runat="server">
  ...
  <!--Link to CSS-->
  <link rel="stylesheet" href="../../App_Styles/ManageReview.css" />
  ...
  <!--Title-->
  <title>Chateau Du Nox - Manage Review</title>
</head>
<body>
                  ...
                  <div class="user-detail">
                    <div class="user-top">
                      ...
                      <div class="user-content">
                        ...
                        <p>Written Date: <%# Eval("WrittenDate") %></p>
                      </div>
                    </div>
                    ...
                    <div class="user-bottom">
                      <asp:Button runat="server" CommandArgument='<%# Eval("ReviewId") %>' CssClass="input-submit" ID="DeleteReview" Text="Delete Review" OnClick="DeleteReview_Click" />
                    </div>
                  </div>
              </ItemTemplate>
            </asp:Repeater>
            ...
            <asp:Repeater runat="server" ID="InactiveRepeater">
              <ItemTemplate>
                <div class="user-detail">
                  ...
                  <div class="user-bottom">
                    <asp:Button runat="server" CommandArgument='<%# Eval("ReviewId") %>' CssClass="input-submit" ID="RecoverReview" Text="Recover Review" OnClick="RecoverReview_Click" />
                  </div>
                </div>
              </ItemTemplate>
            </asp:Repeater>
