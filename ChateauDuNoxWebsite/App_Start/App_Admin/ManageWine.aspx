...
<head runat="server">
  ...
  <!--Link to CSS-->
  <link rel="stylesheet" href="../../App_Styles/ManageWine.css" />
  ...
  <!--Title-->
  <title>Chateau Du Nox - Manage Wine</title>
</head>
<body>
  <form id="form1" runat="server">
    ...
    <div class="user-container">
      <div class="user-wrapper">
        <h1>Manage Wine</h1>
        <asp:Button runat="server" CssClass="input-submit" ID="AddWine" Text="Add New" />
      </div>
        ...
        <div class="modal-wrapper">
          <div class="input-container">
            ...
            <div class="input-detail">
              ...
              <asp:FileUpload ID="AddWineFileUpload" CssClass="input-file" runat="server" />
            </div>
            <div class="input-detail">
      ...
      <div class="modal-content">
        ...
        <div class="modal-wrapper">
          <div class="input-container">
            ...
            <div class="input-detail">
              <asp:Label runat="server" CssClass="input-label" Text="Wine Image"></asp:Label>
              <asp:FileUpload ID="EditWineFileUpload" CssClass="input-file" runat="server" />
            </div>
            <div class="input-detail">
              <asp:Label runat="server" CssClass="input-label" Text="Description"></asp:Label>
              <asp:TextBox runat="server" CssClass="input-textarea" TextMode="MultiLine" Height="50"></asp:TextBox>
