...
<head runat="server">
  ...
  <!--Link to CSS-->
  <link rel="stylesheet" href="../../App_Styles/ManageType.css" />
  ...
  <!--Title-->
  <title>Chateau Du Nox - Manage Type</title>
</head>
<body>
  <form id="form1" runat="server">
    ...
    <div class="user-container">
      <div class="user-wrapper">
        <h1>Manage Wine Type</h1>
        <asp:Button runat="server" CssClass="input-submit" ID="AddType" Text="Add New" />
      </div>
